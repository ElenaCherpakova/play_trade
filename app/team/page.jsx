    ...
    <Box>
      <Box sx={sectionStyle}>
        ...
        <Typography
          ...
          Playtrade is a premier online card trading platform, offering users a seamless and secure
          marketplace to buy, sell, and trade a diverse range of collectible cards. Our platform is
          designed to cater to the needs of both casual collectors and serious enthusiasts,
          providing a user-friendly interface, robust security features, and a vibrant community
          atmosphere. Whether you are searching for rare gems to add to your collection or looking
          to connect with fellow enthusiasts, Playtrade is your ultimate destination for all things
          card trading.
        </Typography>
      </Box>
      <Box sx={sectionStyle}>
